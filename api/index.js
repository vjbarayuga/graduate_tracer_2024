...
// // Search Users based on Educational Attainment
// app.get('/search-users', async (req, res) => {
//   try {
//     const { degree, collegeuniversity, campus, yeargraduated } = req.query;

//     // Build the query object based on the provided filters with case-insensitive regex
//     const query = {
//       'educationalAttainment.degree': new RegExp(degree, 'i'),
//       'educationalAttainment.collegeuniversity': new RegExp(
//         collegeuniversity,
//         'i'
//       ),
//       'educationalAttainment.campus': new RegExp(campus, 'i'),
//       'educationalAttainment.yeargraduated': yeargraduated,
//     };

//     // Use the query object to find users and populate related data
//     const users = await User.find(query)
//       .populate('personalInfo')
//       .populate('educationalAttainment')
//       .populate('trainingsAdvancedStudies')
//       .populate('employment')
//       .exec();
